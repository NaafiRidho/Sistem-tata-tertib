...
<head>
  ...
  <meta name="keywords" content="Data Mahasiswa, Si Tertib">
        ...
        <div class="modal-body">
          <form id="addDataForm">
            ...
            <select class="form-select" id="kelas" required>
              ...
              <option value="SIB 2-A">SIB 2-A</option>
              <option value="SIB 2-B">SIB 2-B</option>
              <option value="SIB 2-C">SIB 2-C</option>
              <option value="SIB 2-D">SIB 2-D</option>
              <option value="SIB 2-E">SIB 2-E</option>
              <option value="SIB 2-F">SIB 2-F</option>
              <option value="TI 2-A">TI 2-A</option>
              <option value="TI 2-B">TI 2-B</option>
              <option value="TI 2-C">TI 2-C</option>
              <option value="TI 2-D">TI 2-D</option>
              <option value="TI 2-E">TI 2-E</option>
              <option value="TI 2-F">TI 2-F</option>
              <option value="TI 2-G">TI 2-G</option>
            </select>
            </div>
